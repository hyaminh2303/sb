...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :creative, 'New Campaign', campaigns_new_path, icon: 'fa fa-plus-circle'
    primary.item :creative, 'Platform Support', platform_supports_path, icon: 'fa fa-question-circle'
